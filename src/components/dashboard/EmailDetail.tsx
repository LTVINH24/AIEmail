...
import { Reply, ReplyAll, Forward, Trash2, MailOpen, Star, Download, Mail } from 'lucide-react';
    ...
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-3 sm:p-6">
          ...
          {/* Email Body */}
          <div
            className="prose prose-sm max-w-none mb-4 sm:mb-6 text-sm sm:text-base"
